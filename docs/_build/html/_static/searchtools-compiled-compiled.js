...
var Search = {
    ...
    for (var prefix in objects) {
      for (var name in objects[prefix]) {
        ...
        if (fullname.toLowerCase().indexOf(object) > -1) {
          ...
          var anchor = match[3];
          if (anchor === '') anchor = fullname;else if (anchor == '-') anchor = objnames[match[1]][1] + '-' + fullname;
  ...
  performTermsSearch: function performTermsSearch(searchterms, excluded, terms, titleterms) {
    ...
    for (i = 0; i < searchterms.length; i++) {
      ...
      var files = [];
      var _o = [{ files: terms[word], score: Scorer.term }, { files: titleterms[word], score: Scorer.title }];
...
//# sourceMappingURL=searchtools-compiled.js.map

//# sourceMappingURL=searchtools-compiled-compiled.js.map