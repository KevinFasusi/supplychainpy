...
function create_shortages_table(data) {
    ...
    for (obj in shortages_data) {
        ...
        $("<tr><td><a href=\"sku_detail/" + sku_identifier(shortages_data[obj].sku_id) + "\">" + shortages_data[obj].sku_id + "</a></td>" +
            ...
            "<td><a href=\"abcxyz/" + shortages_data[obj].abc_xyz_classification + "\">" + shortages_data[obj].abc_xyz_classification + "</a></td></tr>").insertAfter("#shortage-table tr:last");
...
// top shortage pebble
    ...
    $("#lg-shortage-cost").append().html("<h1><strong>" + "$" + format_number(shortages_data[0].shortage_cost) + "</strong></h1>")
        .find("> h1").css("color", "#D11C29");
    $("#lg-shortage-units").append().html("<h1><strong>" +format_number(shortages_data[0].shortages) + " units" + "</strong></h1>")
...
function create_excess_table(data) {
    ...
    for (obj in excess_data) {
        ...
        $("<tr><td><a href=\"sku_detail/" + excess_data[obj].sku_id + "\">" + excess_data[obj].sku_id + "</td>" +
            ...
            "<td><a href=\"abcxyz/" + excess_data[obj].abc_xyz_classification + "\">" + excess_data[obj].abc_xyz_classification + "</a></td></tr>").insertAfter("#excess-table tr:last");
    }
