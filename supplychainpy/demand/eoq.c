...
static char __pyx_k_order_qty[] = "order_qty";
static char __pyx_k_unit_cost[] = "unit_cost";
static char __pyx_k_holding_cost[] = "holding_cost";
static char __pyx_k_order_factor[] = "order_factor";
static char __pyx_k_reorder_cost[] = "reorder_cost";
static char __pyx_k_total_orders[] = "total_orders";
static char __pyx_k_reorder_quantity[] = "reorder_quantity";
static char __pyx_k_eoq_variable_cost[] = "eoq_variable_cost";
...
static char __pyx_k_Users_Fasusi_Projects_supplycha[] = "/Users/Fasusi/Projects/supplychainlibraries/python/supplychainpy/supplychainpy/demand/eoq.pyx";
...
static PyObject *__pyx_pw_13supplychainpy_13supplychainpy_6demand_3eoq_1minimum_variable_cost(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("minimum_variable_cost (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_total_orders)) != 0)) kw_args--;
 ...
 */
  ...
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(5, 0, 12, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_Fasusi_Projects_supplycha, __pyx_n_s_economic_order_quantity, 36, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initeoq(void); /*proto*/
PyMODINIT_FUNC initeoq(void)
#else
PyMODINIT_FUNC PyInit_eoq(void); /*proto*/
PyMODINIT_FUNC PyInit_eoq(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_eoq(void)", 0);
